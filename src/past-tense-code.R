...
#         multiple.irregular.variants = c('begin', 'bid', 'drink', 'ring', 
#                                       'shrink', 'sing', 'sink', 'speak', 
#                                       'spit', 'spring', 'write')
lemmas.to.use = c('awake', 'build', 'burn', 'catch', 'dive', 'draw', 'dream',
                    ...
                    'quit', 'shine', 'sneak', 'speed', 'spell', 'spill', 'spoil',
...
for (i in seq_along(lemmas.to.use)) {
  ...
  # TODO: add instruction to change path or pass variable to script to set this
